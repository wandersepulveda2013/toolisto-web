...
function buildToolPage(tool) {
  const acceptMap = {
    ...
    any: '*/*',
    none: '*/*',
    audios: 'audio/mpeg,audio/wav,audio/ogg,audio/aac,audio/flac,.mp3,.wav,.ogg,.aac,.flac',
    audio: 'audio/mpeg,audio/wav,audio/ogg,audio/aac,audio/flac,.mp3,.wav,.ogg,.aac,.flac',
    videos: 'video/mp4,video/webm,video/quicktime,video/x-msvideo,.mp4,.webm,.mov,.avi,.mkv',
    video: 'video/mp4,video/webm,video/quicktime,video/x-msvideo,.mp4,.webm,.mov,.avi,.mkv',
  };
  const multiple = tool.accepts === 'images' || tool.accepts === 'pdfs' || tool.accepts === 'docs' || tool.accepts === 'txts' || tool.accepts === 'epubs' || tool.accepts === 'csvs' || tool.accepts === 'excels' || tool.accepts === 'jsons' || tool.accepts === 'xmls' || tool.accepts === 'any' || tool.accepts === 'audios' || tool.accepts === 'videos';
...
<body>
  ...
  <script src="./vendor/js/engine-loader.js"></script>
  ...
  <script src="./js/security/local-encryption.js"></script>
  <script src="./js/metadata/photo-location.js"></script>
  <script src="./js/documents/apa7-formatter.js"></script>
