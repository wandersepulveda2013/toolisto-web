// update-index-grid.mjs — Regenerate the toolGrid in toolisto.html from tools.json
...
const toolistoHome = 'toolisto.html';
let html = readFileSync(toolistoHome, 'utf8');
...
writeFileSync(toolistoHome, html);
console.log(`Updated ${toolistoHome} with ${count} tool cards and counter "${countLabel}"`);
