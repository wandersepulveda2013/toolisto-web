...
const expectedDevDependencies = new Set(['@axe-core/playwright', '@ffmpeg/core', '@ffmpeg/ffmpeg', '@ffmpeg/util', '@playwright/test', 'fake-indexeddb', 'lighthouse', 'playwright', 'tesseract.js']);
