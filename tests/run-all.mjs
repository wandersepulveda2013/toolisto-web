...
const tests = [
  ...
  { name: 'CE-070 Evidence-Driven History', cmd: 'node tests/ce070-history-learning-test.mjs' },
  ...
  { name: 'Modern Image Formats', cmd: 'node tests/gate-e2e-modern-image-formats.mjs' },
  { name: 'Advanced Image Tools', cmd: 'node tests/gate-e2e-advanced-image-tools.mjs' },
